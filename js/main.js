document.addEventListener("DOMContentLoaded", function () {
  ...
  if (footer && !footer.querySelector(".footer-email")) {
    ...
    emailP.innerHTML = 'שאלות או רוצה לדעת אם הסיפור שלך פורסם? <a href="mailto:guralea@gmail.com">guralea@gmail.com</a>';
  ...
  waFloat.setAttribute("aria-label", "שלחי הודעה קולית בוואטסאפ");
