...
4. **אבי תורג'מן** - paid ad: **NEW correct-page ad `120248952672740543`, ACTIVE.** ⚠️ **Real incident, 2026-09-11: a second, older ad for Avi under the WRONG page (`120248889451060543`, studio page `2267713623553786`) was mistakenly reactivated by a session investigating a text-corruption false alarm, and ran ACTIVE simultaneously with the correct one for several hours - a direct violation of the "one ad per person, no residue" rule. Deleted 2026-09-11 once found. `120248889451060543` and page `2267713623553786` must never be used for this campaign again - the correct page for every ad in this test campaign is `1190716140784281` ("הגיל הוא לא הסיפור"), not the studio page.**
