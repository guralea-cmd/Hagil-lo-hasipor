...
האתר משתמש ב-Firebase לרישום לקהילה, לקליטת סיפורי קהילה (כולל וידאו) ולפאנל ניהול לאישור תכנים. כל זה עובד בלי שרת משלך - Firebase הוא ה-backend.
...
- **תוכנית חינמית (Spark)**: ל-Firebase יש תוכנית חינמית נדיבה (Firestore, Storage, Auth) שמספיקה להיקף סביר של קהילה. אם תרצו לעבור לגביית תשלום בעתיד, תצטרכו להוסיף ספק סליקה (Stripe / Cardcom / PayPlus) - זה שינוי נפרד מה-backend הנוכחי.
